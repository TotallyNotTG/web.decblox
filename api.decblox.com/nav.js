...
document.write('                        <a href="develop.html"><button class="pages hover">Develop</button></a>');
document.write('                        <a href="currency.html"><button class="pages hover">DECBUX</button></a>');
document.write('                    </div>');
document.write('                </div>');
